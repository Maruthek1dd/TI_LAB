...
soluciones = ["SALADO", "APESTOSO", "PELUDO", "BLANCO",
              "ROCK"]  # PALABRAS A ENCONTRAR EN LA SOPA DE LETRA, NOS SIRVE PARA QUE EL PROGRAMA SEPA SI LA RESPUESTA DEL USUSARIO ES CORRECTA
c = ""
...
print("recuerda, para salir del juego solo debes escribir 'salir' en la consola")
while cont <= 4:
    ...
    if RTA in soluciones:
        ...
        print("repuesta incorrecta o ya escrita, intenta de nuevo: ")
